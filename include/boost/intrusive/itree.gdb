...
#
@boost.add_to_dict(boost.static_method, ('boost::intrusive::detail::itree_value_traits', 'to_value_ptr'))
...
#
@boost.add_to_dict(boost.static_method, ('boost::intrusive::detail::itree_node_traits', 'get_parent'))
...
#   pass call to real node_traits
#
@boost.add_to_dict(boost.static_method, ('boost::intrusive::detail::itree_node_traits', 'get_left'))
...
#   pass call to real node_traits
#
@boost.add_to_dict(boost.static_method, ('boost::intrusive::detail::itree_node_traits', 'get_right'))
